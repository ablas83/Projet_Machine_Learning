...
def connection_database():
    conn_db = psycopg2.connect(
        host=config('ec2-34-247-94-62.eu-west-1.compute.amazonaws.com'),
        database=config('d4on6t2qk9dj5a'),
        user=config('nxebpjsgxecqny'),
        password=config('1da2f1f48e4a37bf64e3344fe7670a6547c169472263b62d042a01a8d08d2114')
    )
    return conn_db

def get_data_to_df(data_name, db):
    if data_name == 'diabete_inde':
